...
if __name__ == '__main__':
    ...
    df1, df23 = train_test_split(df22, train_size=0.33, random_state=42)
    df2, df3 = train_test_split(df23, train_size=0.5, random_state=42)
    ...
    #---------------------train dataset3----------------------------------------
    df3 = df3[list(features)]
    x_train2, x_opt2, x_test2 = np.split(df3.sample(frac=1, random_state=17), [int(1/3*len(df3)), int(2/3*len(df3))])
    scaler2 = StandardScaler()
    scaler2.fit(x_train2.append(x_opt2))
    x_train2 = scaler2.transform(x_train2)
    x_opt2 = scaler2.transform(x_opt2)
    ...
    df1t1, df1t23 = train_test_split(df1t, train_size=0.33, random_state=42)
    df1t2, df1t3 = train_test_split(df1t23, train_size=0.5, random_state=42)
    ...
    #---------------------test dataset3----------------------------------------
    X_test1t2 = df1t3.drop(columns=['malicious']).values
    X_test_scaled1t2 = scaler1t.transform(X_test1t2)
    Y_test1t2 = df1t3['malicious']
